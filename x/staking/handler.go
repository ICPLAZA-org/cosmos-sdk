...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgEditValidatorRecommanderRule:
			res, err := msgServer.EditValidatorRecommanderRule(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)

		case *types.MsgEditValidatorRCommissionRule:
			res, err := msgServer.EditValidatorRCommissionRule(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
