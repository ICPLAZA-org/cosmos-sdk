...
// MaxIncentiveDepth - Maximum depth of incentive
func (k Keeper) MaxIncentiveDepth(ctx sdk.Context) (res uint32) {
	k.paramstore.Get(ctx, types.KeyMaxIncentiveDepth, &res)
	return
}
