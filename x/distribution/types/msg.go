...
const (
	...
	TypeMsgWithdrawTeamCommission      = "withdraw_team_commission"
	TypeMsgFundCommunityPool           = "fund_community_pool"
)

// Verify interface at compile time
var _, _, _, _ sdk.Msg = &MsgSetWithdrawAddress{}, &MsgWithdrawDelegatorReward{}, &MsgWithdrawValidatorCommission{}, &MsgWithdrawTeamCommission{}
...
func NewMsgWithdrawTeamCommission(valAddr sdk.ValAddress, teamAddr sdk.AccAddress) *MsgWithdrawTeamCommission {
	return &MsgWithdrawTeamCommission{
		TeamAddress: teamAddr.String(),
		ValidatorAddress: valAddr.String(),
	}
}

func (msg MsgWithdrawTeamCommission) Route() string { return ModuleName }
func (msg MsgWithdrawTeamCommission) Type() string  { return TypeMsgWithdrawTeamCommission }

// Return address that must sign over msg.GetSignBytes()
func (msg MsgWithdrawTeamCommission) GetSigners() []sdk.AccAddress {
	teamAddr, err := sdk.AccAddressFromBech32(msg.TeamAddress)
	if err != nil {
		panic(err)
	}
	return []sdk.AccAddress{teamAddr.Bytes()}
}

// get the bytes for the message signer to sign on
func (msg MsgWithdrawTeamCommission) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(&msg)
	return sdk.MustSortJSON(bz)
}

// quick validity check
func (msg MsgWithdrawTeamCommission) ValidateBasic() error {
	if msg.TeamAddress == "" {
		return ErrEmptyTeamAddr
	}
	return nil
}
