...
type Params struct {
	...
	DelayedRewardProportion  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=delayed_reward_proportion,json=delayedRewardProportion,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"delayed_reward_proportion" yaml:"delayed_reward_proportion"`
	MinDelayedRewardPeriod   int64                                  `protobuf:"varint,6,opt,name=min_delayed_reward_period,json=minDelayedRewardPeriod,proto3" json:"min_delayed_reward_period,omitempty"`
	MaxDelayedRewardInterval int64                                  `protobuf:"varint,7,opt,name=max_delayed_reward_interval,json=maxDelayedRewardInterval,proto3" json:"max_delayed_reward_interval,omitempty"`
	DelayedRewardUnit        time.Duration                          `protobuf:"bytes,8,opt,name=delayed_reward_unit,json=delayedRewardUnit,proto3,stdduration" json:"delayed_reward_unit,omitempty" yaml:"delayed_reward_unit"`
}
...
func (m *Params) GetMinDelayedRewardPeriod() int64 {
	if m != nil {
		return m.MinDelayedRewardPeriod
	}
	return 0
}

func (m *Params) GetMaxDelayedRewardInterval() int64 {
	if m != nil {
		return m.MaxDelayedRewardInterval
	}
	return 0
}

func (m *Params) GetDelayedRewardUnit() time.Duration {
	if m != nil {
		return m.DelayedRewardUnit
	}
	return 0
}
...
type ValidatorHistoricalRewards struct {
	...
	CumulativeRecommandersRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=cumulative_recommanders_reward_ratio,json=cumulativeRecommandersRewardRatio,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"cumulative_recommanders_reward_ratio" yaml:"cumulative_recommanders_reward_ratio"`
}
...
func (m *ValidatorHistoricalRewards) GetCumulativeRecommandersRewardRatio() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.CumulativeRecommandersRewardRatio
	}
	return nil
}
...
type ValidatorCurrentRewards struct {
	...
	RecommandersRewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=recommanders_rewards,json=recommandersRewards,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"recommanders_rewards"`
}
...
func (m *ValidatorCurrentRewards) GetRecommandersRewards() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.RecommandersRewards
	}
	return nil
}
...
type ValidatorAccumulatedCommission struct {
	...
	TeamCommission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=team_commission,json=teamCommission,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"team_commission"`
}
...
func (m *ValidatorAccumulatedCommission) GetTeamCommission() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.TeamCommission
	}
	return nil
}
...
type ValidatorDelayedReward struct {
	//  Length of the delay period.
	Period     int64                                       `protobuf:"varint,1,opt,name=period,proto3" json:"period,omitempty" yaml:"period"`
	...
	Unit       github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=unit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"unit"`
	Reward     github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,4,rep,name=reward,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"reward"`
}

func (m *ValidatorDelayedReward) Reset()         { *m = ValidatorDelayedReward{} }
func (m *ValidatorDelayedReward) String() string { return proto.CompactTextString(m) }
func (*ValidatorDelayedReward) ProtoMessage()    {}
func (*ValidatorDelayedReward) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{12}
}
func (m *ValidatorDelayedReward) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorDelayedReward) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorDelayedReward.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidatorDelayedReward) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorDelayedReward.Merge(m, src)
}
func (m *ValidatorDelayedReward) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorDelayedReward) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorDelayedReward.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorDelayedReward proto.InternalMessageInfo

type ValidatorDelayedRewardInfo struct {
	LastTime time.Time `protobuf:"bytes,2,opt,name=last_time,json=lastTime,proto3,stdtime" json:"last_time" yaml:"last_time"`
}

func (m *ValidatorDelayedRewardInfo) Reset()         { *m = ValidatorDelayedRewardInfo{} }
func (m *ValidatorDelayedRewardInfo) String() string { return proto.CompactTextString(m) }
func (*ValidatorDelayedRewardInfo) ProtoMessage()    {}
func (*ValidatorDelayedRewardInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{13}
}
func (m *ValidatorDelayedRewardInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorDelayedRewardInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorDelayedRewardInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidatorDelayedRewardInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorDelayedRewardInfo.Merge(m, src)
}
func (m *ValidatorDelayedRewardInfo) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorDelayedRewardInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorDelayedRewardInfo.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorDelayedRewardInfo proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ValidatorDelayedReward)(nil), "cosmos.distribution.v1beta1.ValidatorDelayedReward")
	proto.RegisterType((*ValidatorDelayedRewardInfo)(nil), "cosmos.distribution.v1beta1.ValidatorDelayedRewardInfo")
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.DelayedRewardProportion.Equal(that1.DelayedRewardProportion) {
		return false
	}
	if this.MinDelayedRewardPeriod != that1.MinDelayedRewardPeriod {
		return false
	}
	if this.MaxDelayedRewardInterval != that1.MaxDelayedRewardInterval {
		return false
	}
	if this.DelayedRewardUnit != that1.DelayedRewardUnit {
		return false
	}
	return true
}
func (this *ValidatorHistoricalRewards) Equal(that interface{}) bool {
	...
	if len(this.CumulativeRecommandersRewardRatio) != len(that1.CumulativeRecommandersRewardRatio) {
		return false
	}
	for i := range this.CumulativeRecommandersRewardRatio {
		if !this.CumulativeRecommandersRewardRatio[i].Equal(&that1.CumulativeRecommandersRewardRatio[i]) {
			return false
		}
	}
	return true
...
func (this *ValidatorCurrentRewards) Equal(that interface{}) bool {
	...
	if len(this.RecommandersRewards) != len(that1.RecommandersRewards) {
		return false
	}
	for i := range this.RecommandersRewards {
		if !this.RecommandersRewards[i].Equal(&that1.RecommandersRewards[i]) {
			return false
		}
	}
	return true
...
func (this *ValidatorAccumulatedCommission) Equal(that interface{}) bool {
	...
	if len(this.TeamCommission) != len(that1.TeamCommission) {
		return false
	}
	for i := range this.TeamCommission {
		if !this.TeamCommission[i].Equal(&that1.TeamCommission[i]) {
			return false
		}
	}
	return true
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.DelayedRewardUnit, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.DelayedRewardUnit):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
	...
	i--
	dAtA[i] = 0x42
	if m.MaxDelayedRewardInterval != 0 {
		i = encodeVarintDistribution(dAtA, i, uint64(m.MaxDelayedRewardInterval))
		i--
		dAtA[i] = 0x38
	}
	if m.MinDelayedRewardPeriod != 0 {
		i = encodeVarintDistribution(dAtA, i, uint64(m.MinDelayedRewardPeriod))
		i--
		dAtA[i] = 0x30
	}
	{
		size := m.DelayedRewardProportion.Size()
		i -= size
		if _, err := m.DelayedRewardProportion.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *ValidatorHistoricalRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CumulativeRecommandersRewardRatio) > 0 {
		for iNdEx := len(m.CumulativeRecommandersRewardRatio) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CumulativeRecommandersRewardRatio[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ValidatorCurrentRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RecommandersRewards) > 0 {
		for iNdEx := len(m.RecommandersRewards) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RecommandersRewards[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ValidatorAccumulatedCommission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TeamCommission) > 0 {
		for iNdEx := len(m.TeamCommission) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TeamCommission[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ValidatorDelayedReward) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidatorDelayedReward) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorDelayedReward) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidatorDelayedRewardInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidatorDelayedRewardInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorDelayedRewardInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.LastTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.LastTime):])
	if err3 != nil {
		return 0, err3
	}
	i -= n3
...
func (m *Params) Size() (n int) {
	...
	l = m.DelayedRewardProportion.Size()
	n += 1 + l + sovDistribution(uint64(l))
	if m.MinDelayedRewardPeriod != 0 {
		n += 1 + sovDistribution(uint64(m.MinDelayedRewardPeriod))
	}
	if m.MaxDelayedRewardInterval != 0 {
		n += 1 + sovDistribution(uint64(m.MaxDelayedRewardInterval))
	}
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.DelayedRewardUnit)
	n += 1 + l + sovDistribution(uint64(l))
	return n
}
...
func (m *ValidatorHistoricalRewards) Size() (n int) {
	...
	if len(m.CumulativeRecommandersRewardRatio) > 0 {
		for _, e := range m.CumulativeRecommandersRewardRatio {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorCurrentRewards) Size() (n int) {
	...
	if len(m.RecommandersRewards) > 0 {
		for _, e := range m.RecommandersRewards {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorAccumulatedCommission) Size() (n int) {
	...
	if len(m.TeamCommission) > 0 {
		for _, e := range m.TeamCommission {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorDelayedReward) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ValidatorDelayedRewardInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelayedRewardProportion", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DelayedRewardProportion.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinDelayedRewardPeriod", wireType)
			}
			m.MinDelayedRewardPeriod = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDistribution
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinDelayedRewardPeriod |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDelayedRewardInterval", wireType)
			}
			m.MaxDelayedRewardInterval = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDistribution
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDelayedRewardInterval |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelayedRewardUnit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.DelayedRewardUnit, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ValidatorHistoricalRewards) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CumulativeRecommandersRewardRatio", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CumulativeRecommandersRewardRatio = append(m.CumulativeRecommandersRewardRatio, types.DecCoin{})
			if err := m.CumulativeRecommandersRewardRatio[len(m.CumulativeRecommandersRewardRatio)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ValidatorCurrentRewards) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecommandersRewards", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RecommandersRewards = append(m.RecommandersRewards, types.DecCoin{})
			if err := m.RecommandersRewards[len(m.RecommandersRewards)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ValidatorAccumulatedCommission) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamCommission", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TeamCommission = append(m.TeamCommission, types.DecCoin{})
			if err := m.TeamCommission[len(m.TeamCommission)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ValidatorDelayedReward) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorDelayedReward: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorDelayedReward: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			m.Unit = append(m.Unit, types.DecCoin{})
...
func (m *ValidatorDelayedRewardInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorDelayedRewardInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorDelayedRewardInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
