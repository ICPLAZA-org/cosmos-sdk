...
type QueryValidatorDelayedRewardsRequest struct {
	// validator_address defines the validator address to query for.
	ValidatorAddress string `protobuf:"bytes,1,opt,name=validator_address,json=validatorAddress,proto3" json:"validator_address,omitempty"`
	// pagination defines an optional pagination for the request.
...
func (m *QueryValidatorDelayedRewardsRequest) Reset()         { *m = QueryValidatorDelayedRewardsRequest{} }
func (m *QueryValidatorDelayedRewardsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryValidatorDelayedRewardsRequest) ProtoMessage()    {}
func (*QueryValidatorDelayedRewardsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{8}
}
func (m *QueryValidatorDelayedRewardsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryValidatorDelayedRewardsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryValidatorDelayedRewardsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryValidatorDelayedRewardsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryValidatorDelayedRewardsRequest.Merge(m, src)
}
func (m *QueryValidatorDelayedRewardsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryValidatorDelayedRewardsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryValidatorDelayedRewardsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryValidatorDelayedRewardsRequest proto.InternalMessageInfo

func (m *QueryValidatorDelayedRewardsRequest) GetValidatorAddress() string {
	if m != nil {
		return m.ValidatorAddress
	}
	return ""
...
func (m *QueryValidatorDelayedRewardsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
// Query/ValidatorDelayedRewards RPC method
type QueryValidatorDelayedRewardsResponse struct {
	// commission defines the commision the validator received.
	Rewards    []ValidatorDelayedReward `protobuf:"bytes,1,rep,name=rewards,proto3" json:"rewards"`
	Pagination *query.PageResponse      `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryValidatorDelayedRewardsResponse) Reset()         { *m = QueryValidatorDelayedRewardsResponse{} }
func (m *QueryValidatorDelayedRewardsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryValidatorDelayedRewardsResponse) ProtoMessage()    {}
func (*QueryValidatorDelayedRewardsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{9}
}
func (m *QueryValidatorDelayedRewardsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryValidatorDelayedRewardsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryValidatorDelayedRewardsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryValidatorDelayedRewardsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryValidatorDelayedRewardsResponse.Merge(m, src)
}
func (m *QueryValidatorDelayedRewardsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryValidatorDelayedRewardsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryValidatorDelayedRewardsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryValidatorDelayedRewardsResponse proto.InternalMessageInfo

func (m *QueryValidatorDelayedRewardsResponse) GetRewards() []ValidatorDelayedReward {
	if m != nil {
		return m.Rewards
	}
	return nil
...
func (m *QueryValidatorDelayedRewardsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryDelegationRewardsResponse struct {
	...
	// recommanders_rewards defines the recommanders rewards accrued by a delegation.
	RecommandersRewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=recommanders_rewards,json=recommandersRewards,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"recommanders_rewards"`
}
...
func (m *QueryDelegationRewardsResponse) GetRecommandersRewards() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryValidatorDelayedRewardsRequest)(nil), "cosmos.distribution.v1beta1.QueryValidatorDelayedRewardsRequest")
	proto.RegisterType((*QueryValidatorDelayedRewardsResponse)(nil), "cosmos.distribution.v1beta1.QueryValidatorDelayedRewardsResponse")
...
var fileDescriptor_5efd02cbc06efdc9 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// ValidatorDelayedRewards queries the total rewards accrued by a validator.
	ValidatorDelayedRewards(ctx context.Context, in *QueryValidatorDelayedRewardsRequest, opts ...grpc.CallOption) (*QueryValidatorDelayedRewardsResponse, error)
...
func (c *queryClient) ValidatorDelayedRewards(ctx context.Context, in *QueryValidatorDelayedRewardsRequest, opts ...grpc.CallOption) (*QueryValidatorDelayedRewardsResponse, error) {
	out := new(QueryValidatorDelayedRewardsResponse)
	err := c.cc.Invoke(ctx, "/cosmos.distribution.v1beta1.Query/ValidatorDelayedRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// ValidatorDelayedRewards queries the total rewards accrued by a validator.
	ValidatorDelayedRewards(context.Context, *QueryValidatorDelayedRewardsRequest) (*QueryValidatorDelayedRewardsResponse, error)
	// DelegationRewards queries the total rewards accrued by a delegation.
...
func (*UnimplementedQueryServer) ValidatorDelayedRewards(ctx context.Context, req *QueryValidatorDelayedRewardsRequest) (*QueryValidatorDelayedRewardsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidatorDelayedRewards not implemented")
}
...
func _Query_ValidatorDelayedRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryValidatorDelayedRewardsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ValidatorDelayedRewards(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.distribution.v1beta1.Query/ValidatorDelayedRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ValidatorDelayedRewards(ctx, req.(*QueryValidatorDelayedRewardsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidatorDelayedRewards",
			Handler:    _Query_ValidatorDelayedRewards_Handler,
		},
		{
...
func (m *QueryValidatorDelayedRewardsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryValidatorDelayedRewardsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryValidatorDelayedRewardsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryValidatorDelayedRewardsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryValidatorDelayedRewardsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryValidatorDelayedRewardsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryValidatorDelayedRewardsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryValidatorDelayedRewardsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryValidatorDelayedRewardsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryValidatorDelayedRewardsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryValidatorDelayedRewardsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryValidatorDelayedRewardsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryValidatorDelayedRewardsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryValidatorDelayedRewardsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Rewards = append(m.Rewards, ValidatorDelayedReward{})
